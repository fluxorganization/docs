---
title: "Introduction to the Mintlify starter kit"
description: "Get oriented with the Mintlify starter kit template, including example pages, navigation, components, and customizations you can adapt for your docs."
---
