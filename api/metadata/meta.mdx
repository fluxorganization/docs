---
title: "File metadata endpoints"
description: "Create, retrieve, and delete file metadata records in the Flux Metadata Service using the /api/v1/meta endpoints for uploaded files."
---
