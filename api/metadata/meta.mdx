---
title: "File metadata create, retrieve, and delete endpoints"
description: "Create, retrieve, and delete file metadata records in the Flux Metadata Service, including encrypted filenames, sizes, and MIME types."
---
