---
title: "Thumbnail Service overview: background worker for image and video thumbnails"
description: "Architecture and queue model for the Flux Thumbnail Service, a Bun and FFmpeg worker that generates WebP variants for uploaded files."
---
