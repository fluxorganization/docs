---
title: "Webhook Service overview: signed event delivery"
description: "Architecture of the Flux Drop Webhook Service, a Bun-powered worker that signs and delivers HMAC SHA-256 webhook events to your endpoints."
---
...
When a significant event occurs in the Flux Drop (e.g., a file is uploaded or downloaded), a message is queued for the Webhook Service. The worker then:
