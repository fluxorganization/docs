---
title: "Quickstart: install, configure, and run Flux"
description: "Follow this quickstart to install Flux, configure your project, and run it for the first time, covering prerequisites and the fastest path to first use."
---
