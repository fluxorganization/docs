---
title: "Quickstart: set up Flux and ship your first integration"
description: "Step-by-step quickstart guide to install Flux, configure prerequisites, authenticate, and run your first successful integration in just a few minutes."
---
